        ...
        return Task.FromResult(new SalesBudgetCatalogResponseDto
        {
            Categories = new List<SalesBudgetCategoryDto>
            {
                ...
                new()
                {
                    ...
                    Highlights = new List<SalesBudgetChartPreviewDto>
                    {
                        new() { Id = "velocity_avg_cycle_time", Title = "Tempo médio do ciclo de vendas", Availability = "available_now" },
                        new() { Id = "velocity_by_seller", Title = "Velocidade de conversão por vendedor", Availability = "available_now" },
                        new() { Id = "velocity_by_product", Title = "Velocidade por produto", Availability = "available_now" },
                        new() { Id = "velocity_conversion_acceleration", Title = "Aceleração de conversão", Availability = "available_now" },
